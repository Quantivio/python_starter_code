...
string_double_quoted = "double quoted string" #Declaring a string value with double quotes.

character = 'c' #Declaring a character value with single quotes.

double_quoted_character = "s" #Declaring a character value with double quotes.
